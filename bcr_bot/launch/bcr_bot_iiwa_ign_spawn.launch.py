...
def generate_launch_description():
    ...
    robot_state_publisher = Node(
        ...
        parameters=[
                    ...
                    ['xacro ', join(bcr_bot_path, 'urdf/bcr_bot_iiwa.xacro'),   #UNICA DIFFERENZA
    ...
    gz_ros2_bridge = Node(
        ...
        arguments=[
            "/model/gold_cube/pose@geometry_msgs/msg/PoseStamped[ignition.msgs.Pose",
    ...
    # TF statico per il cubo dorato (posizione dal file SDF)
    gold_cube_tf_publisher = Node(
        package="tf2_ros",
        executable="static_transform_publisher",
        arguments = ["--x", "2.0",
                    "--y", "3.0",
