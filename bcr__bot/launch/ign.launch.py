...
def generate_launch_description():
    ...
    iiwa_path = get_package_share_directory("ros2_iiwa")
    ...
    spawn_iiwa_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(join(iiwa_path, "launch", "iiwa.launch.py")),
        launch_arguments={
            # Pass any arguments if your spawn.launch.py requires
        }.items()
    )
    ...
    return LaunchDescription([
        ...
        gz_sim, spawn_bcr_bot_node, spawn_iiwa_node
    ])
